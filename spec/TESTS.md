...
This document defines the acceptance test dataset and evaluation framework for the Obsidian AI plugin.
...
- Real vault notes/folders involved:
  - `Ideas/`
  - examples include:
    - `Ideas/Idea - Obsidian AI plugin.md`
...
- Priority: high
- Agent: ask
- Prompt: `Append a short summary to @Ideas/Idea - Obsidian AI plugin.md`
- Real vault notes/folders involved:
  - `Ideas/Idea - Obsidian AI plugin.md`
- Behaviors under test:
